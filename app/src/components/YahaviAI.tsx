...
const seed: ChatMsg = {
  role: "bot",
  text:
    "Hey, I'm Yahavi — HackKnow's AI assistant. Ask me anything in any language: " +
    "find a template, filter by price, get a recommendation, or check your order. How can I help?",
  suggestions: [
  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className="fixed bottom-5 right-5 z-[60] w-14 h-14 rounded-2xl bg-hack-yellow text-hack-black border-2 border-hack-black shadow-[4px_4px_0_0_#0A0A0A] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0_0_#0A0A0A] transition-all flex items-center justify-center"
      >
      ...
      {open && (
        <div
          ...
          className="fixed bottom-24 right-5 z-[60] w-[min(380px,calc(100vw-2.5rem))] max-h-[70vh] flex flex-col rounded-2xl bg-white border-2 border-hack-black shadow-[6px_6px_0_0_#0A0A0A] overflow-hidden"
        >
          <header className="flex items-center gap-2 px-4 py-3 bg-hack-black text-white">
            ...
            <div className="leading-tight">
              ...
              <div className="text-[10px] uppercase tracking-wider text-white/60 font-mono">
                HackKnow assistant • any language
              </div>
            </div>
